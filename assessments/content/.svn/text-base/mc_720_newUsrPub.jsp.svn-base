...
<tr>
                <td></td>
                <td colspan="4"><span class='toplink'>Country code / area code / number</span></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            <td><input type='text' class='txtCountry' id='telW' name='telw' value='<%=((newUsr.getTelW() != null) ? newUsr.getTelW() : "")%>'>
                            </td>
                            <td><input type='text' class='txtArea' id='telWa' name='telwa' value='<%=((newUsr.getTelW() != null) ? newUsr.getTelW() : "")%>'>
                            </td>
                            <td><input type='text' class='txtNo' id='telWn' name='telwn' value='<%=((newUsr.getTelW() != null) ? newUsr.getTelW() : "")%>'>
                                &nbsp;<div class='err' style='display:inline'>+</div></td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            <td><input type='text' class='txtCountry' id='telH' name='telh' value='<%=((newUsr.getTelH() != null) ? newUsr.getTelH() : "")%>'>
                            </td>
                            <td><input type='text' class='txtArea' id='telHa' name='telha' value='<%=((newUsr.getTelH() != null) ? newUsr.getTelH() : "")%>'>
                            </td>
                            <td><input type='text' class='txtNo' id='telHn' name='telhn' value='<%=((newUsr.getTelH() != null) ? newUsr.getTelH() : "")%>'>
                                &nbsp;<div class='err' style='display:inline'>+</div></td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            <td><input type='text' class='txtCountry' id='telC' name='telc' value='<%=((newUsr.getTelCell() != null) ? newUsr.getTelCell() : "")%>'>
                            </td>
                            <td><input type='text' class='txtArea' id='telCa' name='telca' value='<%=((newUsr.getTelCell() != null) ? newUsr.getTelCell() : "")%>'>
                            </td>
                            <td><input type='text' class='txtNo' id='telCn' name='telcn' value='<%=((newUsr.getTelCell() != null) ? newUsr.getTelCell() : "")%>'>
                                &nbsp;<div class='err' style='display:inline'>+</div></td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            <td><input type='text' class='txtCountry' id='telF' name='telf' value='<%=((newUsr.getTelFax() != null) ? newUsr.getTelFax() : "")%>'>
                            </td>
                            <td><input type='text' class='txtArea' id='telFa' name='telfa' value='<%=((newUsr.getTelFax() != null) ? newUsr.getTelFax() : "")%>'>
                            </td>
                            <td><input type='text' class='txtNo' id='telFn' name='telfn' value='<%=((newUsr.getTelFax() != null) ? newUsr.getTelFax() : "")%>'>
                                &nbsp;<div class='err' style='display:inline'>+</div></td>
                        </tr>
                    </table>
                </td>
