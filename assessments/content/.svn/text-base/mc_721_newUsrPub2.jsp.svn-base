...
<%
        ...
        if (request.getParameter("confirm") == null)
        {
            ...
            resume.setSkillsSummary(request.getParameter("skillssummary3"));
            resume.setQualificationDetails(request.getParameter("qualificationdetails3"));
            resume.setSalaryRequired(request.getParameter("salaryrequired3"));
            resume.setNoticePeriod(request.getParameter("noticeperiod3"));
