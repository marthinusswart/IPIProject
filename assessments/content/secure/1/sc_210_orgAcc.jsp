...
<style type="text/css">
    ...
    #logoUploadPanel h3 { margin: 0; padding: 0.4em; text-align: center; }
</style>

<link rel='stylesheet' type='text/css' href='http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.11/themes/le-frog/jquery-ui.css'>
...
<script type='text/javascript' src="script/client/jquery-1.5.2.min.js"></script>
<script type='text/javascript' src="script/client/jquery-ui-1.8.11.custom.min.js"></script>
<script type='text/javascript' src="script/client/jquery.fileupload.js"></script>
<script type='text/javascript' src="script/client/jquery.fileupload-ui.js"></script>
...
<script type='text/javascript'>
    $(function() {
        ...
        function runEffect() {
            ...
            // run the effect
            $( "#logoUploadPanel" ).show( 'blind', options, 500 );
        };
...
<form action="index.jsp" method='post'>
    <table class='tbl'>
        ...
        <tr>
            ...
            <td class='bigcell'>
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                <img alt='Company logo' src='<%=((cust != null) && (cust.getLogo() != null) && (!cust.getLogo().equals("")) ? "images/" + cust.getLogo() : "images/ipilogo.jpg")%>' width='150'>
                            </div>
                            <div>
                                <input type="button" id="uploadButton" value="Upload" class="btn2"/>
                            </div>
                        </td>
                    </tr>
            ...
            <td class="bigcell2">
                <div id="logoUploadPanel" class="logoUploadPanel ui-widget-content ui-corner-all">
                    <h3 class="ui-widget-header ui-corner-all">Upload a new company logo</h3>
                    <form id="file_upload" action="upload.php" method="POST" enctype="multipart/form-data">
                        <input type="file" name="file" class="ui-widget-content ui-corner-all">
