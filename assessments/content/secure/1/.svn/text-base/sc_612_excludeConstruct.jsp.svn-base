...
<%
        ...
        else
        {
            if (!errOccurred)
            {
                try
                {
                    constructs = Construct.getIncludedConstructs(qreId);
                }
                catch (Exception ex)
                {
                    errOccurred = true;
...
<div align='center'>
    <div align='left'>
        The following Constructs are included<br /><br />
        ...
        <div class='btnBar'>
            ...
            <div style="float:left;">
                <form action='index.jsp' method='post' style="float:left">
                    <input type='submit' class='btn1' value="Exclude" onclick="return setCs(1);" />
                    <input type='hidden' name='c' id='c1'/>
                    <input type='hidden' name='cname' id='cname1'/>
                    <input type='hidden' name='action' value='excludeconstruct'/>
