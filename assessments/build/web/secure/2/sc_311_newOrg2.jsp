...
if(request.getParameter("username")==null){	// posted from Step 1.
...
<form action='index.jsp' method='post'>
	...
	<table>
		...
		<tr>
			...
			<td><input type='text' class='txt1' id='firstName' name='firstname' value='<%=
				((cust.getUser().getFirstName()!=null)?cust.getUser().getFirstName():"")%>'></td>
		</tr>
		<tr>
			<td>Initial:</td>
			<td><input type='text' class='txt1' id='Initial' name='initial' value='<%=
				((cust.getUser().getInitial()!=null)?cust.getUser().getInitial():"")%>'></td>
		</tr>
		<tr>
			<td><div class='err' style='display:inline'>*</div>&nbsp;&nbsp;Last Name:</td>
			<td><input type='text' class='txt1' id='lastName' name='lastname' value='<%=
				((cust.getUser().getLastName()!=null)?cust.getUser().getLastName():"")%>'></td>
		</tr>
		<tr>
			<td>Title:</td>
			<td>
		...
		<tr>
			<td>ID Number:</td>
			<td><input type='text' class='txt1' id='IDNum' name='idnum' value='<%=
				((cust.getUser().getIDNum()!=null)?cust.getUser().getIDNum():"")%>'></td>
		</tr>
		<tr>
			<td>Company Reference #:</td>
			<td><input type='text' class='txt1' id='compRef' name='compref' value='<%=
				((cust.getUser().getCompanyRef()!=null)?cust.getUser().getCompanyRef():"")%>'></td>
		</tr>
		
		<tr>
			<td>Tel (W):</td>
			<td><input type='text' class='txt1' id='telW' name='telw' value='<%=
				((cust.getUser().getTelW()!=null)?cust.getUser().getTelW():"")%>'></td>
		</tr>
		<tr>
			<td>Tel (H):</td>
			<td><input type='text' class='txt1' id='telH' name='telh' value='<%=
				((cust.getUser().getTelH()!=null)?cust.getUser().getTelH():"")%>'></td>
		</tr>
		<tr>
			<td>Tel (Cell):</td>
			<td><input type='text' class='txt1' id='telC' name='telc' value='<%=
				((cust.getUser().getTelCell()!=null)?cust.getUser().getTelCell():"")%>'></td>
		</tr>
		<tr>
			<td>Tel (Fax):</td>
			<td><input type='text' class='txt1' id='telF' name='telf' value='<%=
				((cust.getUser().getTelFax()!=null)?cust.getUser().getTelFax():"")%>'></td>
		</tr>
		<tr>
			<td>Email:</td>
			<td><input type='text' class='txt1' id='Email' name='email' value='<%=
				((cust.getUser().getEMail()!=null)?cust.getUser().getEMail():"")%>'></td>
		</tr>
	</table>
	</div>
	</p>
