...
<%
        ...
        else
        {
            if (!errOccurred)
            {
                try
                {
                    superConstructs = SuperConstruct.getUnassignedSuperConstructs(qreId);
                }
                catch (Exception ex)
                {
                    errOccurred = true;
        ...
        <div class='btnBar'>
            ...
            <div style="float:left;">
                <form action='index.jsp' method='post' style="float:left">
                    <input type='submit' class='btn1' value="Add" onclick="return setSCs(1);" />
                    <input type='hidden' name='sc' id='sc1'/>
                    <input type='hidden' name='scname' id='scname1'/>
                    <input type='hidden' name='action' value='addsuperconstruct'/>
