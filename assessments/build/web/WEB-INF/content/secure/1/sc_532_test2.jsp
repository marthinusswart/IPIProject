   		...
   		// get the next set of questions
			...
			if(qns == null){
				...
				if(lt.getSplitSet() == lt.getNSplits()+1){		// end of test : COMPLETED
   				...
   				status = TS_COMPLETED;
   				msg =
						"<div class='success'>You've reached the end of this questionaire. Your answers will be processed and the results sent to the relevant parties <i>in due time</i><br><br>"+
