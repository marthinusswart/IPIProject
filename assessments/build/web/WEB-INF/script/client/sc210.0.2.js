<!-- /* (see "mc72.js") */
	...
	function resetCreds(lvl){
		...
		switch(lvl){
			...
			case 1:
				...
				document.getElementById("CredsAvailable").value = document.getElementById("origAdminCreds").value;
				break;
		}
	...
	function xferCred(){
		var availCred	= document.getElementById("CredsAvailable").value;
		availCred++;availCred--;
		if(availCred-1>=0) {
			var currCred	= document.getElementById("Credits").value;
			currCred++;currCred--;
			
			document.getElementById("Credits").value = currCred+1;
			document.getElementById("CredsAvailable").value = availCred-1;
		}
	...
	function update_Click(){
		...
		document.getElementById("ArCode").value = Trim(document.getElementById("ArCode").value).substr(0,12);
		...
		if (str==''){ // no errors
			...
			// .. and if available..
			if(document.getElementById("CredsAvailable") != null)
				document.getElementById("CredsAvailable").disabled = false;
