<!--
	...
	function btnStep2_Click(skipOrg, atype){
		...
		if(!skipOrg){
			...
			code = document.getElementById("Code").value = Trim(document.getElementById("Code").value).substr(0,3);
		...
		if(!skipOrg) {
			var str = '';
			if(name=='') str += 'Please provide a name\n';
			if(code=='') str += 'Please provide a 3-letter company prefix code (for adverts etc.)\n';
